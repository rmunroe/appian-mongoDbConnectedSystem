...
|              |               | -  Fixed an issue with M_eq that was incorrectly converting certain values to JSON                                       |
|              |               | -  Added M_validObjectId to test if a text value is a valid ObjectId hexadecimal                                         |
|              |               | -  Initial release of the Demo Application                                                                               |
|              |               |                                                                                                                          |
+--------------+---------------+--------------------------------------------------------------------------------------------------------------------------+
