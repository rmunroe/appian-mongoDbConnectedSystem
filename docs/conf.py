...
html_logo = 'media/mcsp_logo_full.png'
...
html_context = {
    'css_files': [
        ...
        '_static/theme_overrides.css',  # override defaults from RTD theme
        ],
    }
...
from appianlexer import AppianLexer
lexers['appian'] = AppianLexer(startinline=True)

from mongolexer import MongoJsonLexer
