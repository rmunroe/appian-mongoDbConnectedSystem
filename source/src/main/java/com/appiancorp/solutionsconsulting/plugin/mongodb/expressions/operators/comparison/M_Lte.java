...
public class M_Lte {
    @Function
    public String m_Lte(TypeService typeService, @Parameter TypedValue value) throws JAXBException, ParseException {
        return MongoDbJsonHelper.buildBasicOperator(typeService, "$lte", value);
    }
}