...
public class M_Ne {
    @Function
    public String m_Ne(TypeService typeService, @Parameter TypedValue value) throws JAXBException, ParseException {
        return MongoDbJsonHelper.buildBasicOperator(typeService, "$ne", value);
    }
}